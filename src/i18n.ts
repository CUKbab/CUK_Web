...
export const translations = {
  ...
  ko: {
    ...
    'feature_requires_login': '이 기능은 로그인이 필요합니다',
    ...
    'macos_download_desc': 'Mac의 프로세서에 맞는 버전을 선택하세요',
    'mac_arm64_title': 'Apple Silicon',
  ...
  ja: {
    ...
    'feature_requires_login': 'この機能にはログインが必要です',
    ...
    'delete_account_confirm': 'この操作は元に戻せません。すべてのデータとレポートが永久に削除されます。',
    'clients_title': 'クライアント',
    'android_app_desc': 'Google PlayストアでCUK밥을ダウンロードして、より快適なモバイル体験を！',
  ...
  zh: {
    ...
    'feature_requires_login': '此功能需要登录',
